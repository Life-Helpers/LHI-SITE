...
export const PUBLICATIONS = [
  ...
  },
  {
    ...
    description: "Young people in Sokoto overcoming depression through IPT-G group therapy (Plan International).",
    pdf: "/documents/helpers-digest-december-2023.pdf",
    post: "/blog/helpers-digest-december-2023",
    image: LHI_PHOTOS.iptgMasud,
  },
  {
    title: "Compendium of IHP Success Stories",
    kind: "Helpers Digest",
    period: "November – December",
    description: "Child health, malaria and nutrition training results at 17 facilities in Sokoto and Kebbi (USAID IHP).",
    pdf: "/documents/ihp-success-stories-compendium.pdf",
    post: "/blog/compendium-of-ihp-success-stories",
    image: LHI_PHOTOS.ihpTrainingSession,
  },
  {
    title: "Reaching for the Stars",
    kind: "Helpers Digest",
    period: "September 2021",
    description: "Girls for Girls (G4G) in Fune LGA, Yobe State (UNICEF / KfW).",
    pdf: "/documents/helpers-digest-reaching-for-the-stars.pdf",
    post: "/blog/reaching-for-the-stars-g4g-yobe",
    image: LHI_PHOTOS.g4gReadingFestival,
  },
  {
    title: "CBHVs, Agents of Change",
    kind: "Helpers Digest",
    period: "September 2019",
    description: "770 community-based health volunteers under the SHOW project in Sokoto (Plan International / Global Affairs Canada).",
    pdf: "/documents/helpers-digest-cbhvs-agents-of-change.pdf",
    post: "/blog/cbhvs-agents-of-change-show-sokoto",
    image: LHI_PHOTOS.cbhvCounselling,
  },
];
