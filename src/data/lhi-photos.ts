...
export const LHI_PHOTOS = {
  ...
  g4gZamfaraSkills: p("g4g-zamfara-vocational-skills", "Three G4G girls in Shinkafi LGA, Zamfara State, holding the beadwork and slippers they learned to make"),
  ...
  // "Health Ambassadors" photo collection (captions in data/program-galleries.ts)
  healthAmbassadorsTraining: p("health-ambassadors-training", "Health ambassadors and LHI staff seated together after a community health educators' training"),
  maternalHealthSession: p("maternal-health-session", "LHI health workers leading a maternal and child health session with mothers under a tree"),
  nutritionAwarenessCooking: p("nutrition-awareness-cooking", "Women gathered round a cooking pot at an LHI nutrition awareness session"),
  nidakePadsGirls: p("nidake-pads-girls", "Schoolgirls in white hijabs holding NIDAKE reusable sanitary pad packs"),
  nutritionCookingDemo: p("nutrition-cooking-demonstration", "Mothers and children watching a community nutrition cooking demonstration"),
  immunisationRegister: p("immunisation-register", "Health worker vaccinating a baby beside a child immunisation register"),
  healthAwarenessHall: p("health-awareness-training-hall", "Health workers at an LHI health awareness and training session in a hall"),
  communityGathering: p("community-gathering-fulfilled-life", "Community members gathered under a tree for an LHI community meeting"),
  nutritionAwarenessWomen: p("nutrition-awareness-women", "Women preparing local foods at an LHI nutrition awareness session"),
  microGardenPots: p("micro-garden-pots", "Women learning to grow vegetables in pots at a micro-garden training"),
  vaccinationOutreach: p("vaccination-outreach", "Health worker immunising a child held by her mother during outreach"),
  nidakePadEducation: p("nidake-pad-education-class", "Girls in a classroom during a NIDAKE menstrual hygiene education session"),
  nutritionMotherChild: p("nutrition-mother-child-bha", "Mother feeding her child from a cup during a nutrition session under the BHA project"),
  immunisationAdvocacy: p("immunisation-advocacy", "Health worker using a picture chart to talk to a mother and her daughter about immunisation"),
  microGardenCommunity: p("micro-garden-community", "Women watching a micro-garden planting demonstration in a community garden"),
  vaccinationChampions: p("vaccination-champions", "Health worker using a counselling card with mothers during an immunisation session"),
