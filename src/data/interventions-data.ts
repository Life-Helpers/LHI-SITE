...
export const INTERVENTIONS_DATA: InterventionProject[] = [
  ...
  project({
    ...
    locations: "Goronyo, Rabah, Isa and Sabon Birni LGAs, Sokoto State: 7 PHCs and 3 mobile/IDP clinics",
    states: ["sokoto"],
    pillars: ["health"],
    photo: "integratedClinicTeam",
    summary:
      "In an IRC-led consortium with ALIMA, COOPI and GISCOR, funded by the US Government's Office of Humanitarian Assistance (formerly BHA), LHI was the health and nutrition lead for Sokoto State, serving displaced people and host communities through supported PHCs, mobile clinics and community nutrition programmes.",
    keyInterventions: [
      "Primary healthcare: outpatient, maternal, newborn, child, reproductive and mental health (MHPSS) services.",
      "Emergency, secondary and tertiary referrals with ambulance and financial support.",
      "SAM treatment at Lajinge and Makuwana OTPs, community screening and the Family MUAC approach.",
      "Tom Brown programme for moderate acute malnutrition, Mother-to-Mother and Men-to-Men support groups.",
      "Facility renovation, health worker training and mentoring, and a pharmaceutical warehouse upgrade with IRC.",
    ],
    impactMetric:
      "109,225 outpatient consultations, 76,257 children screened, 9,614 children treated for SAM and 5,635 skilled deliveries (May 2023 – June 2026).",
    tags: ["irc", "usg", "oha", "nutrition", "idp"],
  }),
  project({
